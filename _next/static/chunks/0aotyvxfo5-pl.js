(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function m(t) {
      ...
      let H = z ? a && "object" == typeof a && a.ref : $,
      ...
      return (
        (0, p.isAbsoluteUrl)(D)
          ? (U.href = D)
          : (z && !I && ("a" !== a.type || "href" in a.props)) ||
            (U.href = (0, h.addBasePath)(D)),
        (m = z
          ? s.default.cloneElement(a, U)
          : (0, o.jsx)("a", { ...P, ...U, children: n })),
      ...
      (
        ...
        (0, t.createElement)(
          "svg",
          {
            ...
            height: i,
            stroke: e,
            strokeWidth: o ? (24 * Number(a)) / Number(i) : a,
          ...
          return (
            ...
            (0, t.jsxs)("section", {
              ...
              children: [
                ...
                (0, t.jsx)("div", {
                  className:
                    "absolute bottom-0 left-0 right-0 z-10 flex flex-col items-center justify-center pb-5 gap-1",
                  children: (0, t.jsxs)("a", {
                    href: c,
  ...
  (e, t, r) => {
    ...
    var c =
      ...
      void 0 === window.document.createElement
        ...
        : function (e, t) {
            var r = t(),
              i = a({ inst: { value: r, getSnapshot: t } }),
              n = i[0].inst,
              c = i[1];
            return (
              s(
                function () {
                  (n.value = r), (n.getSnapshot = t), d(n) && c({ inst: n });
                },
                [e, r, t]
              ),
              o(
        ...
        let [f, x] = b(t, p),
          ...
          w = () => {
            ...
            return ("function" == typeof a.revalidate
              ? a.revalidate(f().data, r)
              : !1 !== a.revalidate) && (delete y[p], delete v[p], e && e[0])
              ? e[0](2).then(() => f().data)
              : f().data;
          };
            ...
            g = () => {
              if (
                ...
                let t = r.initFocus(setTimeout.bind(l, $.bind(l, i, 0))),
                  n = r.initReconnect(setTimeout.bind(l, $.bind(l, i, 1)));
                a = () => {
                  t && t(), n && n(), o.delete(e);
                };
              }
      ...
      B = p(
        {
          ...
          compare: function e(t, r) {
            ...
            if (t && r && (i = t.constructor) === r.constructor) {
              ...
              if (i === Array) {
                if ((n = t.length) === r.length) for (; n-- && e(t[n], r[n]); );
                return -1 === n;
              }
              if (!i || "object" == typeof t) {
                for (i in ((n = 0), t))
                  if (
                    (a.call(t, i) && ++n && !a.call(r, i)) ||
                    !(i in r) ||
                    !e(t[i], r[i])
                  )
                    return !1;
      ...
      X = (e, t) => {
        ...
        if (t) {
          let { use: i, fallback: n } = e,
            { use: a, fallback: o } = t;
          i && a && (r.use = i.concat(a)), n && o && (r.fallback = p(n, o));
        }
        return r;
      },
      D = (0, i.createContext)({});
    ...
    d.defineProperty(
      (e) => {
        let { value: t } = e,
          ...
          o = (0, i.useMemo)(() => (n ? a : X(r, a)), [n, r, a]),
          s = a && a.provider,
          d = (0, i.useRef)(l);
        s && !d.current && (d.current = F(s(o.cache || P), a));
        let c = d.current;
        return (
    ...
    let J =
        ((t = (e, t, r) => {
          let {
            ...
            er = I[R] && I[R].length > 0,
            ei = et.data,
            en = c(ei) ? (Y && "function" == typeof Y.then ? G(Y) : Y) : ei,
            ea = et.error,
            eo = (0, i.useRef)(en),
            es = w ? (c(ei) ? (c(eo.current) ? en : eo.current) : ei) : en,
            el = R && c(en),
            ed = (0, i.useRef)(null);
          S ||
          ...
          let ep =
            ...
            ex = (0, i.useCallback)(
              async (e) => {
                let t,
                  i,
                  n = P.current;
                if (!R || !n || $.current || O.current.isPaused()) return !1;
                let a = !0,
                  o = e || {},
                  d = !C[R] || !o.dedupe,
                  p = () =>
                  ...
                  if (
                    (d &&
                      ...
                      r.loadingTimeout &&
                        c(X().data) &&
                        setTimeout(() => {
                          a && p() && O.current.onLoadingSlow(R, r);
                        }, r.loadingTimeout),
                      (C[R] = [n(N), A()])),
                    ([t, i] = C[R]),
                    (t = await t),
            ...
            eu = (0, i.useCallback)((...e) => M(a, F.current, ...e), []);
          if (
            (T(() => {
            ...
            let e = L[R];
            if ((G(!c(e) && el ? eu(e) : q), !c(ea) && el)) throw ea;
            let i = el ? ex(K) : q;
                      ...
                      children: [
                        ...
                        (0, r.jsxs)("span", {
                          style: {
                            ...
                            fontWeight: 700,
                            color:
                              n <= 10 ? "#fbbf24" : "rgba(255,255,255,.55)",
                            minWidth: 22,
                            textAlign: "right",
                            transition: "color 0.3s",
                          },
                    ...
                    return (0, t.jsx)(
                      "a",
                      {
                        ...
                        style: {
                          ...
                          background:
                            e === i ? "rgba(240,185,11,.06)" : "transparent",
                          borderBottom:
                            e === i
                              ? "1px solid rgba(240,185,11,.35)"
    ...
    e.s([
      ...
      function () {
        return (0, t.jsxs)("section", {
          ...
          style: { height: "340px" },
          "aria-label": "$BABYSPACEMOON Ecosystem",
          children: [
            (0, t.jsx)("div", {
  ...
  (e) => {
    ...
    let i = [
        {
          ...
          title: "Introduction",
          content: [
            "$BABYSPACEMOON didn't start as a project.",
            ...
            "$BABYSPACEMOON doesn't predict the future. It reveals what's already in motion...",
          ],
        },
        {
          id: "narrative",
          ...
          content: [
            ...
            "$BABYSPACEMOON emerges as the meme version of that hypothesis: What if it was never about separate companies? What if it was always about integration?",
          ],
        },
        {
          id: "concept",
          ...
          title: "The Concept",
          content: [
            "$BABYSPACEMOON represents the convergence of three forces:",
        ...
        },
        {
          ...
          content: [
            "$BABYSPACEMOON is a CTO — Community Takeover.",
        ...
        },
        {
          ...
          content: [
            ...
            "$BABYSPACEMOON takes a different path.",
        ...
        },
        {
          ...
          title: "Ecosystem",
          content: [
            "$BABYSPACEMOON expands through: X → real-time narrative. Medium → structured lore. TikTok / Memes → viral distribution. Community → coordination.",
        ...
        },
        {
          ...
          title: "The Lore",
          content: [
            "The $BABYSPACEMOON story unfolds in episodes.",
        ...
        },
        {
          ...
          title: "Disclaimer",
          content: [
            "$BABYSPACEMOON is a project rooted in culture and entertainment.",
      ...
      n = [
        ...
        { label: "REV: CTO-1.0", color: "#f0b90b" },
        { label: "CHAIN: BSC", color: "#a78bfa" },
        { label: "TICKER: $BABYSPACEMOON", color: "#fbbf24" },
        { label: "SUPPLY: 1,000,000,000", color: "rgba(255,255,255,.28)" },
        { label: "LP: BURNED", color: "#f87171" },
        { label: "TAXES: 0% / 0%", color: "#34d399" },
        { label: "OWNERSHIP: RENOUNCED", color: "#f0b90b" }
      ],
      a = [
        { base: "#f0b90b", glow: "rgba(240,185,11,.25)" },
    ...
    function o({ i: e, active: r }) {
      let i = a[e] ?? a[0],
        n = r ? i.base : "rgba(255,255,255,0.25)",
        s = [
          (0, t.jsxs)(
            "svg",
            {
              ...
              children: [
                ...
                (0, t.jsx)("circle", { cx: "10", cy: "10", r: "1.5", fill: n }),
                (0, t.jsx)("line", {
                  x1: "10",
                  y1: "1",
                  x2: "10",
          ...
          (0, t.jsxs)(
            "svg",
            {
              ...
              children: [
                ...
                (0, t.jsx)("circle", { cx: "10", cy: "10", r: "1.8", fill: n }),
              ],
            },
            "c"
          ),
          ...
          (0, t.jsxs)(
            "svg",
            {
              ...
              children: [
                ...
                (0, t.jsx)("circle", { cx: "10", cy: "3", r: "1.2", fill: n }),
                (0, t.jsx)("line", {
                  x1: "2",
                  y1: "9",
                  x2: "4.5",
          ...
          (0, t.jsxs)(
            "svg",
            {
              ...
              fill: "none",
              children: [
                (0, t.jsx)("circle", { cx: "10", cy: "10", r: "2", fill: n }),
                (0, t.jsx)("circle", {
                  cx: "10",
                  cy: "3",
                  r: "1.5",
      ...
      `,
                    ...
                    (0, t.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, t.jsxs)("p", {
                          ...
                          children: [
                            "$BABYSPACEMOON doesn't predict the future.",
                            (0, t.jsx)("br", {}),
            ...
            e &&
              (0, t.jsxs)("div", {
                role: "dialog",
                "aria-modal": "true",
                "aria-label": "$BABYSPACEMOON Whitepaper",
                style: {
                  position: "fixed",
                  inset: 0,
                  zIndex: 9999,
                  ...
                  (0, t.jsxs)("div", {
                    style: {
                      ...
                      animation: c
                        ...
                        : "none",
                      boxShadow:
                        "0 0 120px rgba(240,185,11,.06),0 0 200px rgba(52,211,153,.04),0 0 0 1px rgba(255,255,255,.06) inset",
                    },
                    children: [
                      (0, t.jsx)("div", {
                        "aria-hidden": !0,
                        style: {
                          ...
                          borderRadius: "50%",
                          background:
                            "radial-gradient(circle,rgba(240,185,11,.06) 0%,transparent 70%)",
                          pointerEvents: "none",
                          zIndex: 0,
                        },
                      }),
                          ...
                          (0, t.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, t.jsx)("span", {
                                ...
                                children: "$BABYSPACEMOON // CTO WHITEPAPER",
                              }),
                            ],
                          }),
                          (0, t.jsxs)("div", {
  ...
  (e) => {
    ...
    function o({ visible: e }) {
      ...
      (0, r.useEffect)(() => {
        ...
        let r = null,
          i = (e) => {
            r || (r = e);
            let n = Math.min((e - r) / 1600, 1);
            a(n), n < 1 && (t = requestAnimationFrame(i));
          };
      ...
      return (0, t.jsxs)("svg", {
        ...
        children: [
          ...
          (0, t.jsx)("circle", {
            ...
            strokeLinecap: "round",
            strokeDasharray: i,
            strokeDashoffset: i * (1 - s(n)),
            transform: "rotate(-90 110 110)",
            style: { filter: "drop-shadow(0 0 8px rgba(240,185,11,.55))" },
          }),
          (0, t.jsxs)("defs", {
            children: [
              (0, t.jsxs)("linearGradient", {
                ...
                y2: "0%",
                children: [
                  (0, t.jsx)("stop", { offset: "0%", stopColor: "#f0b90b" }),
          ...
          n > 0.05 &&
            (0, t.jsx)("circle", {
              cx: 110 + 88 * Math.cos(2 * s(n) * Math.PI - Math.PI / 2),
              cy: 110 + 88 * Math.sin(2 * s(n) * Math.PI - Math.PI / 2),
              r: 5,
              fill: "#f0b90b",
              style: { filter: "drop-shadow(0 0 6px #f0b90b)" },
            }),
        ],
      });
    }
    ...
    e.s([
      ...
      function () {
        ...
        @keyframes tok-glow-pulse{0%,100%{box-shadow:0 0 0 rgba(240,185,11,0)}50%{box-shadow:0 0 32px rgba(240,185,11,.12)}}
      ...
      `,
              ...
              (0, t.jsx)("div", {
                ...
                style: {
                  ...
                  height: 180,
                  background:
                    "linear-gradient(180deg,transparent,rgba(240,185,11,.025),transparent)",
              ...
              (0, t.jsx)("div", {
                ...
                style: {
                  ...
                  borderRadius: "50%",
                  background:
                    "radial-gradient(circle,rgba(240,185,11,.05) 0%,transparent 65%)",
                  pointerEvents: "none",
                  zIndex: 0,
                },
              }),
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              (0, t.jsx)("span", {
                                style: {
                                  ...
                                  height: 1,
                                  background:
                                    "linear-gradient(90deg,rgba(240,185,11,.3),transparent)",
                                },
                              }),
                              (0, t.jsx)("span", {
                                style: {
                          ...
                          (0, t.jsxs)("button", {
                            ...
                            style: {
                              ...
                              padding: "16px 20px",
                              background:
                                "linear-gradient(135deg,rgba(240,185,11,.07),rgba(0,0,0,.6))",
                              border: `1px solid ${
                                c
                                  ? "rgba(52,211,153,.5)"
                                  : "rgba(240,185,11,.3)"
                            ...
                            children: [
                              (0, t.jsx)("div", {
                                ...
                                style: {
                                  ...
                                  height: "100%",
                                  background:
                                    "linear-gradient(90deg,transparent,rgba(240,185,11,.08),transparent)",
                        ...
                        children: [
                          ...
                          (0, t.jsx)("div", {
                            ...
                            style: {
                              ...
                              height: 300,
                              borderRadius: "50%",
                              border: "1px dashed rgba(240,185,11,.04)",
                              animation:
                        ...
                        children: [
                          ...
                          (0, t.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, t.jsx)("span", {
                                style: { color: "#f0b90b", fontWeight: 700 },
                                children: "0% / 0%",
                              }),
                            ],
                          }),
    ...
    let i = [
      {
        ...
        story: `$BABYSPACEMOON isn't just a bet.
...
$BABYSPACEMOON is already positioned where attention will converge.

Just look at Polymarket. The signal is there.

But this goes deeper than strategy.

$BABYSPACEMOON is the shadow reflection of SpaceX.
...
$BABYSPACEMOON is led by Elon Musk… but not the version you think you know.
...
$BABYSPACEMOON built Mars to reach you.
...
You didn't find $BABYSPACEMOON.
$BABYSPACEMOON found you.
...
$BABYSPACEMOON wasn't born on a launchpad.
...
$BABYSPACEMOON isn't just a ticker.
...
The IPO. If $BABYSPACEMOON ends up being the ticker chosen for SpaceX…
...
And $BABYSPACEMOON… Could already feel the pulse of this new reality.`,
        classified: !1,
      },
      {
        id: "ep9",
...
When $BABYSPACEMOON finally gets chosen, it won't be the beginning.
...
And $BABYSPACEMOON… isn't about to begin.
...
When the ticker $BABYSPACEMOON is finally chosen, it won't come as a shock.
...
The colony is waiting for the ones who caught the signal.`,
    ...
    function n({ ep: e, index: i, onOpen: a }) {
      ...
      `,
              ...
              (0, t.jsx)("div", {
                ...
                style: {
                  ...
                  borderRadius: "50%",
                  background:
                    "radial-gradient(circle,rgba(240,185,11,.04) 0%,transparent 70%)",
                  pointerEvents: "none",
                      ...
                      (0, t.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, t.jsx)("span", {
                            ...
                            children: "$BABYSPACEMOON // LORE ARCHIVE",
                          }),
                        ],
                      }),
                      (0, t.jsxs)("div", {
                            ...
                            children: [
                              (0, t.jsxs)("p", {
                                ...
                                children: [
                                  ...
                                  (0, t.jsx)("br", {}),
                                  "you'll be rewarded in $BABYSPACEMOON.",
                                ],
                              }),
                              (0, t.jsx)("div", {
                                style: {
              ...
              s && (0, t.jsx)(a, { ep: s, onClose: () => l(null) }),
            ],
          })
        );
      },
  ...
  (e) => {
      ...
      return (
        (0, r.useEffect)(() => {
          ...
          let o = Array.from({ length: 60 }, () => ({
            ...
            s = () => {
              for (let e of (i.clearRect(0, 0, n, a), o)) {
                (e.x += e.vx),
                  (e.y += e.vy),
                  (e.life += 0.004),
                  (e.y < -4 || e.life > 1) &&
                    ((e.y = a + 4), (e.x = Math.random() * n), (e.life = 0));
    ...
    function n({ side: e }) {
      let r = "01ABCDEF234$BABYSPACEMOON89EF012345678",
    ...
    function a() {
      ...
      return (
        (0, r.useEffect)(() => {
          ...
          let a = 0,
            o = () => {
              a++, i.clearRect(0, 0, 320, 320);
              for (let e = 0; e < 8; e++) {
                let t = (e / 8) * Math.PI * 2 + 0.003 * a,
              ...
              i.createConicalGradient,
                ...
                n.forEach((e) => {
                  ...
                  let t = 160 + Math.cos(e.angle) * e.radius,
                    ...
                    n = 0.3 * Math.sin(0.04 * a + e.angle) + 0.7;
                  i.beginPath(),
                    i.arc(t, r, e.size * n, 0, 2 * Math.PI),
                    (i.fillStyle = `rgba(52,211,153,${e.opacity * n})`),
                    i.fill(),
                    i.beginPath(),
                    i.arc(
                ...
                children: (0, t.jsx)("div", {
                  ...
                  children: [void 0, void 0]
                    .flatMap(() => [
                      ...
                      { label: "$BABYSPACEMOON", color: "#34d399" },
                      {
                  ...
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, t.jsxs)("p", {
                        ...
                        children: [
                          "Independent security review of the $BABYSPACEMOON smart contract by Coinsult.",
                          (0, t.jsx)("br", {}),
                      ...
                      (0, t.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, t.jsxs)("p", {
                            ...
                            children: [
                              "The $BABYSPACEMOON smart contract has been fully audited by Coinsult and certified safe.",
                              (0, t.jsx)("br", {}),
  ...
  (e) => {
    ...
    let i = [
      ...
      },
      {
        ...
        label: "X Community",
        sublabel: "COMMUNITY",
        href: "https://x.com/i/communities/1934268770014351653",
        color: "#f0b90b",
        glow: "rgba(240,185,11,.2)",
        status: "live",
        icon: (e) =>
          (0, t.jsxs)("svg", {
            ...
            strokeLinejoin: "round",
            children: [
              (0, t.jsx)("circle", { cx: "9", cy: "7", r: "3" }),
              (0, t.jsx)("circle", { cx: "16", cy: "7", r: "3" }),
              (0, t.jsx)("path", {
                d: "M3 20c0-3.3 2.7-6 6-6h6c3.3 0 6 2.7 6 6",
              }),
              (0, t.jsx)("path", { d: "M16 4c1.7 0 3 1.3 3 3s-1.3 3-3 3" }),
              (0, t.jsx)("path", { d: "M21 20c0-2.8-1.8-5.2-4.4-6" }),
            ],
          }),
      },
      {
    ...
    let a = [
      ...
      { label: "X COMMUNITY", color: "#f0b90b" },
                      ...
                      (0, t.jsxs)("h2", {
                        ...
                        children: [
                          ...
                          (0, t.jsx)("span", {
                            ...
                            children: "the $BABYSPACEMOON Network",
                          }),
                        ],
                      }),
                      (0, t.jsxs)("p", {
      ...
      function () {
        ...
        let s = [
          ...
          },
          {
            ...
            tag: "FOLLOW & DM",
            value: "@BabySpaceMoon",
            display: "@BabySpaceMoon",
            note: null,
            color: "#22d3ee",
            glow: "rgba(34,211,238,.15)",
            href: "https://x.com/BabySpaceMoon",
            copyable: !1,
            icon: (e) =>
              (0, t.jsx)("svg", {
                width: "26",
      ...
      `,
            ...
            (0, t.jsx)("div", {
              ...
              style: {
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle,rgba(240,185,11,.04),transparent 70%)",
                pointerEvents: "none",
              },
            }),
            (0, t.jsx)("div", {
  ...
  (e) => {
    ...
    e.s([
      ...
      function () {
              ...
              r.clearRect(0, 0, t.width, t.height),
                i.forEach((e) => {
                  ...
                  r.beginPath(),
                    ...
                    (r.fillStyle = `rgba(240,185,11,${0.5 * i})`),
                    r.fill(),
                    (e.y -= e.speed),
                    e.y < -2 &&
        ...
        @keyframes cab-pulse {
          0%,100% { box-shadow: 0 0 0   0   ${a}.0), inset 0 0 0   0   ${a}.0); border-color:${a}.15); }
          50%     { box-shadow: 0 0 24px 4px ${a}.08),inset 0 0 16px 2px ${a}.03); border-color:${a}.40); }
        }
        @keyframes cab-glow-dot {
          0%,100% { box-shadow:0 0 5px 2px ${a}.7); opacity:1; }
          50%     { box-shadow:0 0 10px 3px ${a}.3); opacity:.5; }
        }
      ...
      `,
            ...
            (0, t.jsxs)("section", {
              ...
              style: {
                position: "relative",
                background: "#050a12",
                borderTop: `1px solid ${a}.08)`,
                borderBottom: `1px solid ${a}.08)`,
                overflow: "hidden",
                minHeight: "auto",
              },
              children: [
                ...
                (0, t.jsx)("div", {
                  style: {
                    ...
                    zIndex: 0,
                    pointerEvents: "none",
                    background: `radial-gradient(ellipse 70% 60% at 50% 50%, ${a}.04) 0%, transparent 70%)`,
                  },
                }),
                (0, t.jsx)("div", {
                  style: {
                    ...
                    height: 1,
                    top: `${x}%`,
                    background: `linear-gradient(90deg, transparent 0%, ${a}.08) 40%, ${a}.15) 50%, ${a}.08) 60%, transparent 100%)`,
                    pointerEvents: "none",
                    zIndex: 1,
                  },
                }),
                (0, t.jsx)("div", {
                  style: {
                    borderBottom: `1px solid ${a}.07)`,
                    overflow: "hidden",
                    whiteSpace: "nowrap",
                    padding: "7px 0",
                    background: `linear-gradient(90deg, ${a}.03), ${a}.015), ${a}.03))`,
                    position: "relative",
                    zIndex: 2,
                  },
                  children: (0, t.jsx)("div", {
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            (0, t.jsx)("span", {
                              style: {
                                flex: 1,
                                height: 1,
                                background: `linear-gradient(90deg,${a}.3),transparent)`,
                              },
                            }),
                            (0, t.jsx)("span", {
                              style: {
                    ...
                    (0, t.jsxs)("div", {
                      ...
                      style: {
                        position: "relative",
                        overflow: "hidden",
                        border: `1px solid ${a}.2)`,
                        borderLeft: `3px solid ${n}`,
                        background: d
                          ? `linear-gradient(135deg, ${a}.05) 0%, ${a}.02) 100%)`
                          : `linear-gradient(135deg, ${a}.03) 0%, ${a}.01) 100%)`,
                        borderRadius: 2,
                        ...
                        boxShadow: d
                          ? `0 0 28px 2px ${a}.06), inset 0 0 16px 0 ${a}.03)`
                          : "none",
                      },
                      children: [
                        ["tl", "tr", "bl", "br"].map((e) =>
                        ...
                        (0, t.jsx)("button", {
                          ...
                          style: {
                            ...
                            textTransform: "uppercase",
                            color: e ? n : `${a}.7)`,
                            background: e ? `${a}.10)` : `${a}.05)`,
                            border: `1px solid ${e ? a + ".30)" : a + ".15)"}`,
                            borderRadius: 2,
                            padding: "8px 16px",
                            cursor: "pointer",
                            transition: "all .25s",
                            whiteSpace: "nowrap",
                            boxShadow: e ? `0 0 12px 2px ${a}.15)` : "none",
                          },
                    ...
                    (0, t.jsx)("p", {
                      ...
                      children:
                        "Click to copy · Always verify before buying · $BABYSPACEMOON on BSC",
                    }),
                  ],
                }),
                (0, t.jsx)("div", {
                  style: {
                    borderTop: `1px solid ${a}.07)`,
                    overflow: "hidden",
                    whiteSpace: "nowrap",
                    padding: "7px 0",
                    background: `linear-gradient(90deg, ${a}.03), ${a}.015), ${a}.03))`,
                      ...
                      .map((e, r) =>
                        (0, t.jsx)(
                          "span",
                          {
                            ...
                            children:
                              "BUY $BABYSPACEMOON · PUMP.FUN · MAKING LIFE MULTIPLANETARY · BSC · JOIN THE MISSION ·",
                          },
                          r
                        )
                      ),
