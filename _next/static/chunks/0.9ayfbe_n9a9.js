(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function o() {
      return !(function () {
        if ("u" < typeof window) {
          let { workUnitAsyncStorage: t } = e.r(96981),
            r = t.getStore();
          if (!r) return !1;
          switch (r.type) {
            case "prerender":
  ...
  (e, t, r) => {
    ...
    let n = "u" < typeof window ? e.r(29777).workAsyncStorage : void 0;
    function a({ error: e }) {
      if (n) {
        let t = n.getStore();
  ...
  (e, t, r) => {
    ...
    let l = e.r(8190),
      d = e.r(32339),
      f = e.r(44442),
      p = "u" > typeof window && (0, d.isBot)(window.navigator.userAgent);
    class m extends s.default.Component {
      static {
  ...
  (e, t, r) => {
    ...
    Object.defineProperty(r, "__esModule", { value: !0 }),
      ...
      e.r(42099).HTTP_ERROR_FALLBACK_ERROR_CODE,
      ("function" == typeof r.default ||
        ("object" == typeof r.default && null !== r.default)) &&
        void 0 === r.default.__esModule &&
        (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let u = (n = e.r(91983)) && n.__esModule ? n : { default: n },
      c = e.r(34072),
      l = e.r(71296),
      d = e.r(96981),
      f = e.r(29777),
...
${t}`
  ...
  (e, t, r) => {
    ...
    let n =
      "u" < typeof window
        ? e.r(8001).unstable_rethrow
        : e.r(67204).unstable_rethrow;
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let o = e.r(44066)._(e.r(91983)),
      ...
      l = e.r(31581),
      d = e.r(47994),
      f = "u" < typeof window ? e.r(78562).useDynamicRouteParams : void 0,
      p = "u" < typeof window ? e.r(78562).useDynamicSearchParams : void 0,
      {
    ...
    function b() {
      return f?.("usePathname()"), (0, o.useContext)(s.PathnameContext);
    }
    function _() {
    ...
    function E() {
      return f?.("useParams()"), (0, o.useContext)(s.PathParamsContext);
    }
    ...
    function v(e = "children") {
      f?.("useSelectedLayoutSegment()"),
        (0, o.useContext)(s.NavigationPromisesContext);
      let t = R(e);
  ...
  (e, t, r) => {
    ...
    let o = e.r(38429),
      ...
      s = i[o.METADATA_BOUNDARY_NAME.slice(0)],
      u = i[o.VIEWPORT_BOUNDARY_NAME.slice(0)],
      c = i[o.OUTLET_BOUNDARY_NAME.slice(0)],
      l = i[o.ROOT_LAYOUT_BOUNDARY_NAME.slice(0)];
  },
]);
